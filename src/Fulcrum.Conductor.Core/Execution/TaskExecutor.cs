...
public sealed class TaskExecutor(
    ...
    : ITaskExecutor
{
    public async Task<TaskResult> ExecuteAsync(Task task, TemplateContext context, CancellationToken cancellationToken)
    {
        try
        {
    ...
    private async Task<TaskResult> ExecuteLoopAsync(Task task, TemplateContext context,
    ...
    private bool EvaluateFailedWhen(Task task, ModuleResult result, TemplateContext context)
    {
    ...
    private bool EvaluateChangedWhen(Task task, ModuleResult result, TemplateContext context)
    {
